package com.obstacle.avoid.util.debug;
...
public class DebugCameraConfig {
    ...
    //names of keys-value map or names of our values inside json file
    ...
    private void load(){
        try {
            ...
            log.error("Errror loading " + FILE_PATH + " using defaults", e);
            setupDefaults();
        }
    }
